...
export function renderRecipesPage(container, { recipes, costsById, sortState }) {
  container.innerHTML = `
    ...
    <div class="field" style="max-width: 360px;">
      ...
      <input class="input" type="search" id="recipe-search" placeholder="Escribí un nombre..." />
    </div>
    ...
    <div id="recipes-table-region">
      ${renderDataTable({
        ...
        rows: recipes,
        emptyMessage: 'Todavía no cargaste ninguna receta.',
        rowActionsHtml: (row) => `
          <div class="row gap-2">
